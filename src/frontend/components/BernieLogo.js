...
export default class BernieLogo extends React.Component {
  ...
  static propTypes = {
    bottomSwooshColor : React.PropTypes.string,
  ...
  return (
    <SvgIcon {...this.props}>
    <g>
      <path stroke={this.props.bottomSwooshColor} fill={this.props.bottomSwooshColor} d="M480,146.5c0,0-1.8-0.4-5.1-1.1c-1.7-0.4-3.7-0.7-6.1-1.2c-2.4-0.4-5.2-0.9-8.3-1.4
