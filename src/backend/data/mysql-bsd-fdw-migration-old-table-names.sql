CREATE FOREIGN TABLE IF NOT EXISTS cons_addr(
...
CREATE FOREIGN TABLE IF NOT EXISTS cons_email(
...
CREATE FOREIGN TABLE IF NOT EXISTS event_attendee(
...
CREATE FOREIGN TABLE IF NOT EXISTS event_type(
...
CREATE FOREIGN TABLE IF NOT EXISTS event(
...
CREATE FOREIGN TABLE IF NOT EXISTS cons_group(
...
CREATE FOREIGN TABLE IF NOT EXISTS cons(
  cons_id INTEGER NOT NULL,
...
CREATE FOREIGN TABLE IF NOT EXISTS cons_phone(
...
CREATE FOREIGN TABLE IF NOT EXISTS signup_form_field(
...
CREATE FOREIGN TABLE IF NOT EXISTS signup_form(
  signup_form_id INTEGER NOT NULL,
